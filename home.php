    ...
    <nav id="sidebar" class="shadow">
        <div id="sidebar_content">
            ...
            <li class="side-item dropdown">
                ...
                <ul class="dropdown-menu">
                    <a class="dropdown-item bg-light" href="#"><h6>Roteamento Interno</h6></a>
                    ...
                    <a class="dropdown-item bg-light" href="#"><h6>Roteamento Externo</h6></a>
            ...
            <li class="side-item dropdown">
                ...
                <ul class="dropdown-menu">
				<a class="dropdown-item bg-light" href="#"><h6>Filas</h6></a>
        ...
        <div class="container mx-5">
            <div class="card p-3 my-5 shadow border-0">
