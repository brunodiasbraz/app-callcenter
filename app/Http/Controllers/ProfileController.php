...
class ProfileController extends Controller
{
    ...
    public function update(ProfileRequest $request)
    {
        ...
        try {
            ...
            // Salvar log
            Log::warning('Perfil não editado.', ['error' => $e->getMessage(), 'action_user_id' => Auth::id()]);
    ...
    public function updatePassword(Request $request)
    {
        ...
        try {
            ...
            // Salvar log
            Log::warning('Senha do perfil não editada.', ['error' => $e->getMessage(), 'action_user_id' => Auth::id()]);
